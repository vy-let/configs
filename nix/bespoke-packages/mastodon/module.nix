# This was copied from the mainline nixpkgs repo in order to locally correct a
# nonsensical bug in the assertions and proceed with a system update.
...
in {
  ...
  config = lib.mkIf cfg.enable (lib.mkMerge [{
    assertions = [
      ...
      #   '';
      # }
      # TODO: Once this assertion gets fixed this whole file override will be unnecessary.
      {
